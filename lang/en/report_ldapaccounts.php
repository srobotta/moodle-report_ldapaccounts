...
$string['datefieldsync'] = 'Date field in LDAP';
$string['datefieldsync_desc'] = 'The LDAP field with date and time, that is used to select new accounts that need to be checked whether they can be synchronized.';
...
$string['ldapaccountsynctask'] = 'Sync new accounts from LDAP to add user in Moodle';
...
$string['synccheck_1'] = 'Setting report_ldapaccounts | ldapusernamefield is empty.';
$string['synccheck_2'] = 'Server setting for LDAP connection is incomplete.';
$string['synccheck_3'] = 'Cannot connect to server / execute query.';
$string['synccheck_4'] = 'Field in report_ldapaccounts | ldapusernamefield seems not to exist in ldap tree.';
